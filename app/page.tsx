    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <section className="mb-10">
          ...
          <p className="text-gray-600 mb-8">Discover our exquisite collection of custom-designed clothing</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Hand-Stitched Blouse Designs</h3>
                <p className="text-gray-600">Elegant and intricate blouses, carefully crafted by hand for a perfect fit.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Hand Embroidery</h3>
                <p className="text-gray-600">Timeless embroidery designs, stitched with precision to add charm to your outfit.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Machine Embroidery</h3>
                <p className="text-gray-600">Modern and detailed embroidery patterns, created with high-quality machine stitching.</p>
              </div>
            </div>
          </div>
        </section>
